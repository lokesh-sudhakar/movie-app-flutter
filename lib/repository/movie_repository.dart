...
class MovieRepository {
  ...
  Future<MovieResponse> getNowPlayingMovies() async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.NOW_PLAYING_MOVIES_URL,queryParameters: params);
  ...
  Future<GenresResponse> getGenres() async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.GENRE_LIST_URL,queryParameters: params);
  ...
  Future<MovieResponse> getGenreMovies(String genreId) async {
    ...
    try {
      Response response = await _dio.get(
          ApiUrl.GENRE_MOVIES_URL, queryParameters: params);
      MovieResponse movieResponse = MovieResponse.fromJson(response.data);
  ...
  Future<PersonsResponse> getTrendingPersons() async{
    ...
    try {
      Response response = await _dio.get(ApiUrl.TRENDING_PERSONS_URL,queryParameters: params);
  ...
  Future<MovieResponse> getPopularMovies() async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.POPULAR_MOVIES_URL, queryParameters: params);
      return MovieResponse.fromJson(response.data);
    } catch (error, stacktrace) {
      print("Request failed with status: ->  $error and stack trace -> $stacktrace");
      return MovieResponse.withError("$error");
    }
  }
  ...
  Future<MovieDetailResponse> getMovieDetail(int id) async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.MOVIE_INFO_URL + "/$id", queryParameters: params);
  ...
  Future<CastResponse> getCasts(int id) async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.MOVIE_INFO_URL + "/$id" + "/credits", queryParameters: params);
  ...
  Future<MovieResponse> getSimilarMovies(int id) async {
    ...
    try {
      Response response = await _dio.get(ApiUrl.MOVIE_INFO_URL + "/$id" + "/similar", queryParameters: params);
      return MovieResponse.fromJson(response.data);
    } catch (error, stacktrace) {
      print("Exception occured: $error stackTrace: $stacktrace");
      return MovieResponse.withError("$error");
